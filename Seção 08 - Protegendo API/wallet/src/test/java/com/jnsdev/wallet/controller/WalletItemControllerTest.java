...
public class WalletItemControllerTest {
	...
	public void testFindBetweenDates() throws Exception {
		...
		BDDMockito.given(
				service.findBetweenDates(
						Mockito.anyLong(), Mockito.any(Date.class), Mockito.any(Date.class), Mockito.anyInt())).willReturn(page);
		
		String param = "/1?startDate=" + startDate + "&endDate=" + endDate;
		
		mvc.perform(MockMvcRequestBuilders.get(URL + param)
				.contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON))
	...
	public void testFindByType() throws Exception {
		...
		String param = "/type/1?type=ENTRADA";
	...
	public void testUpdateInvalidId() throws Exception {
		...
		mvc.perform(MockMvcRequestBuilders.put(URL).content(getJsonPayload()).contentType(MediaType.APPLICATION_JSON)
